...
<head>
    ...
    <title>Santalink | Loans Given</title>
...
<body class="nav-md">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
									<form method="post"> 
										<p>Loans Issued Out </p>		
											<span class="section">Search Loans Period</span>			
											<div class="field item form-group">
												<label class="col-form-label col-md-3 col-sm-3  label-align">Date From<span class="required">*</span></label>
													<div class="col-md-3 col-sm-3">
														<input class="form-control datepick" name="date_from" value="<?php echo date('d-m-Y'); ?>" required="required" />
														Date To
													</div>
													<div class="col-md-3 col-sm-3">
														<input class="form-control datepick2" name="date_to" value="<?php echo date('d-m-Y'); ?>" required="required" />
													</div>
											</div>
										...
										<div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    <button type='button' onclick="view_report(date_from.value,date_to.value,client_id.value)" name="submit" class="btn btn-primary">View Report</button>
    ...
    <script>
		...
		function view_report(date_from,date_to,client_id) {
			// window.open(url, width, height);
			var windowWidth = 900;
			var windowHeight = 900;
			var description = "client_loans_given";
			var url = "clients_loans_given_final.php?date_from="+date_from+"&date_to="+date_to+"&client_id="+client_id;
