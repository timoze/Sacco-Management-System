                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $row) {
                                                ...
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control email" type="email" name="mail_host" id="mail_host" value="<?php echo $row->mail_host;?>" required  disabled='true'/></div>
                                                </div>
                                                <div class="field item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Mail Username<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control email" type="email" name="mail_username" id="mail_username" value="<?php echo $row->mail_username;?>" required  disabled='true'/></div>
                                                </div>
                                                <div class="field item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Mail Port <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control number" type="number"  name="mail_port" id="mail_port" value="<?php echo $row->mail_port ;?>" required='required' placeholder="Mail Port" disabled='true'></div>
                                                </div>
