...
<html>
<head>
	  <title>Badili Group | Contributions List </title>
    <!-- Bootstrap -->
          ...
          <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <a href='javascript: void(0)' onclick=javascript:poptastic('./new_contribution.php',700,500,'new_invoice') title='Click to Add New Invoice' style='text-decoration:none'><button class='btn btn-success'>New Contribution</button></a>
								...
								$staus = "1";
								$sql="SELECT * from  member_contribution WHERE status= :staus $search_query order by contribution_date desc";
                 ...
                 // $total_paid = get_amount_paid($dbh, $invoice_id);
									...
									$view = '<a id="other" class="dropdown-item" href="javascript: void(0)" onclick=javascript:poptastic("./view-invoice.php?invoiceid='.$row->id.'","670","500","view_invoice") title="Click to View" style="text-decoration:none">View Details</a>';
									$edit = '<a id="other" class="dropdown-item" href="javascript: void(0)" onclick=javascript:poptastic("./edit_contributions_details.php?editid='.$row->id.'","670","500","edit_invoice") title="Click to Edit Invoice" style="text-decoration:none">Edit</a>';
									$makepayments = '<a id="other" class="dropdown-item" href="javascript: void(0)" onclick=javascript:poptastic("./invoice_payment.php?invoiceid='.$row->id.'","1000","900","invoice_payment") title="Click to Make Payments" style="text-decoration:none">Make Payments</a>';
                  
                  
									//$delete = '<a href="delete_invoice.php?invoice_id='.$row->invoice_id.'" title="Click to Delete" style="text-decoration:none">Delete</a>';
									$delete = '<a id="other" class="dropdown-item" href="javascript: void(0)" onclick=javascript:poptastic("./delete_contribution.php?invoice_id='.$row->id.'","670","500","delete_invoice") title="Click to Delete " style="text-decoration:none">Delete</a>';
                    ...
                    ?>
                        <tr class="active">
                            ...
                            <td style="text-align: right;" nowrap="nowrap"><?php  echo htmlentities($payment_type);?></td>
                            <td style="text-align: right;" nowrap="nowrap"><?php  echo htmlentities(number_format($row->contribution_amount,2));?></td>									      								         
                        ...
                        $total_amount += $row->contribution_amount;
