...
<head>
    ...
    <title>Santalink | Payments Made</title>
...
<body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
									<form method="post"> 
										<p>Payments Made </p>		
											<span class="section">Search Payments Made Period</span>			
    ...
    <script>
		...
		function view_report(date_from,date_to,client_id) {
			...
			var description = "clients_payments";
			var url = "clients_payments.php?date_from="+date_from+"&date_to="+date_to+"&client_id="+client_id;
