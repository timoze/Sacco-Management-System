...
if (!CheckSession()) {
    ...
    //$repayment_startdate = $today_date + GRACE_PERIOD;
    $repayment_startdate = date('d-m-Y', strtotime($today_date. ' + '.GRACE_PERIOD.' days'));
  	?>
<!DOCTYPE HTML>
<html>
<head>
	<title>Badili Sacco | Approve Member Loan </title>
	<!-- Bootstrap -->
...
<body class="nav-md">
					...
					<div class="x_panel">
						<div class="x_content">
							<table  width="100%" border="0"> 
                                ...
                                <tr>
									<td colspan="2"><B><font color="red" size=4>APPROVE LOAN MEMBER LOAN</font></B></td>	
                                            ...
                                            <?php
                                                if ($loan_details_array[0][8]=='1') {
                                                    ...
                                                    for ($g_count=0; $g_count <count($guarantor_details_array) ; $g_count++) {
                                                        ...
                                                        if ($logged_inuser == $guarantorid) {
                                                            $guarantor_detailsarr[0] = array($guarantoritem_id, $loan_id, $guarantorid , $guarantoramount, $status_desc);
                                                        }
                                                          ?>
                                                            <tr>
                                                                <td>
                                ...
                                ?>
                                <tr>
									<td colspan="3" style="text-align: left;"><B><font color=red>6.  APPROVAL  </font></B> Pending <span> <img src="<?php echo $pending;?>" width="20px" height="20px"> </span> Approved <span><img src="<?php echo $approved;?>" width="20px" height="20px"> </span> Denied <span><img src="<?php echo $denied;?>" width="20px" height="20px"> </span> </td>	
								</tr>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <?php
                                                    if ($loan_details_array[0][11] == '0') {
                                                        ?>	
                                                        <div id="approve_member_loanbutton"><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#approve_member_loan-modal">Approve</button></div>
                                                        <?php
                                                    }
                                                ?>
                                                    <div id="approve_member_loan-modal" class="modal fade" role="dialog">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">				
                                                                <div class="modal-body">
                                                                    <form class="approve_member_loan" name="approve_member_loan">
                                                                        <span class="section">Approve Loan Request</span>
                                                                        <div class="field item form-group">
                                                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Amount: <span class="required"></span></label>
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <input class="form-control" type="text"  name="loanamount" id="loanamount" required='required' value="<?php echo number_format($loan_details_array[0][4],2);?>" readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="field item form-group">
                                                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Disbursement Date:<span class="required">*</span></label>
                                                                                <div class="col-md-9 col-sm-9">
                                                                                    <input class="form-control "  name="disbursement_date" id="disbursement_date" onchange="updateStartdate(this.value)" value="<?php echo $today_date;?>" required="required" />
                                                                                </div>
                                                                        </div>
                                                                        <div class="field item form-group">
                                                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Start Date:<span class="required">*</span></label>
                                                                                <div class="col-md-9 col-sm-9">
                                                                                    <input class="form-control "  name="repayment_start_date" id="repayment_start_date" value="<?php echo $repayment_startdate;?>" required="required" readonly />
                                                                                </div>
                                                                        </div>
                                                                        <div class="field item form-group">
                                                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Approve / Decline: <span class="required"></span></label>
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <select name="loan_status" id="loan_status" placeholder="Approve or decline Loan Request ..."  class="form-control " required='true'>
                                                                        ...
                                                                        <div class="field item form-group">
                                                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Comments: <span class="required"></span></label>
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <textarea name="comments" id="comments" class="input-xlarge"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <input type="hidden" id="loan_id" name="loan_id" value="<?php echo $loan_id;?>">
                                                                        <input type="hidden" id="approver" name="approver" value="<?php echo $logged_inuser;?>">
                                                                        <input type="hidden" id="loan_memberid" name="loan_memberid" value="<?php echo $loan_details_array[0][1];?>">
                                                                        <input type="hidden" id="repayment_period" name="repayment_period" value="<?php echo $loan_details_array[0][7];?>">
                                                                        <input type="hidden" id="loan_amount_approve" name="loan_amount_approve" value="<?php echo $loan_details_array[0][4];?>">
                                                                    </form>
                                                                </div>	
                                                                <div class="modal-footer">
                                                                    <button class="btn btn-success" id="submit">Approve</button>
	...
	$("button#submit").click(function(){
        ...
        var repayment_start_date = document.getElementById("repayment_start_date").value;
        var approver = document.getElementById("approver").value;
        var loan_memberid = document.getElementById("loan_memberid").value;
        var repayment_period = document.getElementById("repayment_period").value;
        var loan_amount_approve = document.getElementById("loan_amount_approve").value;
        ...
        var rowData = {
            ...
            loan_amount_approve     :   loan_amount_approve,
            repayment_period        :   repayment_period,
            loan_memberid           :   loan_memberid,
            disbursement_date       :   disbursement_date
            };
		$.ajax({
			type: "POST",
			url: "approve_member_loan.php",
			data: rowData,
			success: function(data){
				//$("#approve_member_loan").html(message);
               // alert(data);
				$("#approve_member_loan-modal").modal('hide'); 
    ...
    <script>
        ...
        function updateStartdate(disb_date){
            ...
            var rowData = {
                ...
                return $.ajax({
                type: "POST",
                url: "update_start_date.php",
                data: rowData,
                success: function(data){
                  //  document.write(data);
                    var startdate = document.getElementById("repayment_start_date");
