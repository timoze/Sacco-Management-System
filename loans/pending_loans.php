...
<html>
<head>
	  <title>Badili Sacco | Pending Loans </title>
    <!-- Bootstrap -->
                          ...
                          <div class="col-sm-12">
                            <div class="card-box ">
                                <form method="post" id="form1" novalidate>
                                    <table id="pending_loan_list" class="table table-striped table-bordered" style="width:100%"> 
                                        <thead> 
                                            <tr> 
                                                ...
                                                <th style="text-align: center;">Total<br>Paid</th>
                                                <th style="text-align: center;">Principal <br>Amount</th>
                                                <th style="text-align: center;">Interest<br>Amount</th>
                                                <th style="text-align: center;">Loan</br>Balance</th> 
                                                <th style="text-align: center;" id="other">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            { 
                                                ...
                                                $search_query = " WHERE member_id=:loggeduser and status=:staus ";
                                            }
                                            else{
                                                $search_query= " WHERE status=:staus";
                                            }
                                            $staus = 1;
                                            ...
                                            $cnt=1;
                                            $total_loan_amount        =   0;
                                            $total_total_principal_amount   =   0;
                                            $total_interest           =   0;
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $row) {
                                                    ...
                                                    $total_principal_paid =     get_loan_principal_paid($id);
                                                    $total_interest_paid  =     get_loan_interest_paid($id);
                                                    $total_amount_paid = $total_interest_paid + $total_principal_paid;
                                                    $bal_due = $loan_amount - $total_principal_paid;
                                                    if ($status=="0") {
                                                    //$status_desc = "PENDING";
                                                    ...
                                                    ?>
                                                        <tr class="active">
                                                            ...
                                                            <td  style="text-align: right;"><?php  echo htmlentities(number_format($total_amount_paid,2));?></td>
                                                            <td  style="text-align: right;"><?php  echo htmlentities(number_format($total_principal_paid,2));?></td>
                                                            <td  style="text-align: right;"><?php  echo htmlentities(number_format($total_interest_paid,2));?></td>
                                                            <td  style="text-align: right;"><?php  echo htmlentities(number_format($bal_due,2));?></td>
                                                    ...
                                                    $total_total_principal_amount = $total_total_principal_amount + $total_principal_paid;
                                                    $total_interest = $total_interest + $total_interest_paid;
                                                    $total_total_payments = $total_total_payments + $total_amount_paid;
                                                    $total_total_bal = $total_total_bal + $bal_due;
                                                }
                                                ?>
                                                </tbody> 
                                                <tfoot>
                                                        <tr class="active">
                                                            ...
                                                            <th  style="text-align: right;"><?php  echo htmlentities(number_format($total_total_principal_amount,2));?></th>
                                                            <th  style="text-align: right;"><?php  echo htmlentities(number_format($total_interest,2));?></th>
                                                            <th  style="text-align: right;"><?php  echo htmlentities(number_format($total_total_bal,2));?></th>
                                                            <th id="other"></th>
                                                        </tr>
...
<script type="text/javascript" src="../vendors/datatables.net-vfs_fonts/vfs_fonts.js"></script>
    ...
    <script>
      ...
      $(document).ready(function() {
          var table = $('#pending_loan_list').DataTable( {
              processing: true,
              responsive: false,
              dom: 'Bfrtip',
              buttons: [
