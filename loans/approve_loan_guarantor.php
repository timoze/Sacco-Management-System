...
<html>
<head>
	<title>Badili Sacco | Approve Guarantor Section </title>
	<!-- Bootstrap -->
					...
					<div class="x_panel">
						<div class="x_content">
							<table  width="100%" border="0"> 
                                ...
                                <tr>
									<td colspan="2"><B><font color="red" size=4>LOAN APPLICATION FORM - APPROVE GUARANTOR SECTION</font></B></td>	
                                                ...
                                                if ($loan_details_array[0][8]=='1') {
                                                    ...
                                                    for ($g_count=0; $g_count <count($guarantor_details_array) ; $g_count++) {
                                                        ...
                                                        if ($logged_inuser == $guarantorid) {
                                                            $guarantor_detailsarr[0] = array($guarantoritem_id, $loan_id, $guarantorid , $guarantoramount, $status_desc,$guarantorstatus);
                                                        }
                                                          ?>
                                                            <tr>
                                                                <td>
									...
									<td colspan="3" style="text-align: left;">
                                        <table>
                                            <tr>
                                                <td width="100%">
                                                <?php
                                                    if ($guarantor_detailsarr[0][5] == '0') {
                                                        ?>	  
                                                <div id="approve_guaranteebutton"><button type="button" class="btn btn-info btn-lg"
 data-toggle="modal" data-target="#approve_guarantee-modal">Approve</button></div>
 <?php
                                                    }
                                                ?>


	<div id="approve_guarantee-modal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">				
				<div class="modal-body">
					<form class="approve_guarantee" name="approve_guarantee">
                        <span class="section">Approve Loan Guarantee Request</span>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Amount Guaranteed: <span class="required"></span></label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" type="text"  name="amountguaranteed" id="amountguaranteed" required='required' value="<?php echo number_format($guarantor_detailsarr[0][3],2);?>" readonly>
                            </div>
                        </div>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Approve / Decline: <span class="required"></span></label>
                            <div class="col-md-6 col-sm-6">
                                <select name="loan_status" id="loan_status" placeholder="Approve or decline Guarantee Request ..."  class="form-control " required='true'>
                        ...
                        <input type="hidden" id="guarantor_item_id" name="guarantor_item_id" value="<?php echo $guarantor_detailsarr[0][0] ;?>">
                        <input type="hidden" id="loan_id_guarantor" name="loan_id_guarantor" value="<?php echo $guarantor_detailsarr[0][1] ;?>">
                        <input type="hidden" id="guarantor_id" name="guarantor_id" value="<?php echo $guarantor_detailsarr[0][2] ;?>">
					</form>
				</div>			
	...
	$("button#submit").click(function(){
        ...
        var guarantor_item_id = document.getElementById('guarantor_item_id').value;
        var loan_id_guarantor = document.getElementById("loan_id_guarantor").value;
        var guarantor_id = document.getElementById("guarantor_id").value;
        var amountguaranteed = document.getElementById('amountguaranteed').value;
        var rowData = {
            loan_status         :   loan_status,
            comments            :   comments,        
            guarantor_item_id   :   guarantor_item_id,
            loan_id_guarantor   :   loan_id_guarantor,
            guarantor_id        :   guarantor_id,     
            amountguaranteed    :   amountguaranteed
            };
		$.ajax({
			type: "POST",
			url: "approve_guarantee.php",
			data: rowData,
			success: function(data){
				//$("#approve_guarantee").html(message);
                //alert(data);
				$("#approve_guarantee-modal").modal('hide'); 
