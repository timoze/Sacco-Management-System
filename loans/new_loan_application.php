        ...
        if ($amount<=$max_amount && $amount<=$member_limit && $query_pending_count == 0) {
           ...
           // $loan_id_insert = mysqli_insert_id($connection);
            ...
            if ($loan_id_insert>0) 
            {
                ...
                echo "<script>window.location.href ='new_loan_application.php?op=ok'</script>";
            } 
           else 
            {
                echo "<script>window.location.href ='new_loan_application.php?op=3'</script>";
            }
        } else {
            echo "<script>window.location.href ='new_loan_application.php?op=1'</script>";
        }
    } else {
        echo "<script>window.location.href ='new_loan_application.php?op=2'</script>";
    }     
    // }
} ?>
<!DOCTYPE html>
