...
if (!CheckSession()) {
    ...
    $eid=$_GET['editid'];
      if (isset($_POST['submit'])) {
            ...
            $role            =   $_POST['role'];
              $sql="UPDATE user_roles set role=:role where role_id=:eid ";
              ...
              if ($count>0) {
                $audit_description = "Updated User Role (" . $role .")";
                 audit_trail($dbh, $audit_description, $logged_inuser);
                  echo "<script>window.location.href ='edit_user_role.php?editid=$role_id&op=ok'</script>";
              } else {
                  echo "<script>window.location.href ='edit_user_role.php?editid=$role_id&op=no'</script>";
              }
      } ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    ...
                                    <?php
										$sql="SELECT * from user_roles where role_id=:eid";
										$query = $dbh -> prepare($sql);
                                            ...
                                            foreach ($results as $row) {
                                                ...
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control" name="role" id="role" value="<?php echo $row->role ;?>" placeholder="User Role" required/>
                                                    </div>
                                                </div>
